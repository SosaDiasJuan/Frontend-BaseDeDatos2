...
export default function SectoresEvento({ sectores, compact = false }) {
  return (
    <div className={`event-sectors ${compact ? 'event-sectors-compact' : ''}`} aria-label="Sectores habilitados">
      {sectores.map((sector) => (
